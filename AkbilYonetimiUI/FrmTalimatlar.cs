    ...
    public partial class FrmTalimatlar : Form
    {
        ...
        private void BekleyenTalimatSayisiniGetir()
        {
            try
            {
                ...
                var bekleyen = context.KullaniciTalimatlaris.Where(x => x.KullaniciId == GenelIslemler.GirisYapanKullaniciID && !x.YuklendiMi);
        ...
        private void TalimatlariDataGrideGetir(bool tumunuGoster = false)
        {
            try
            {
                var talimatlar = context.KullaniciTalimatlaris.Where(x => x.KullaniciId == GenelIslemler.GirisYapanKullaniciID);
